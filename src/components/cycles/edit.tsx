    ...
    interface Country {
      ...
      name: string;
        ...
        .then(res => {
          ...
          setDepartureLocation(res.data.departureLocationId)
          setArrivalLocation(res.data.arrivalLocationId)
          setReturnLocation(res.data.returnLocationId)
          setReturnArrivalLocation(res.data.returnArrivalLocationId)
